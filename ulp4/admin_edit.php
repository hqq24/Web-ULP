...
<?php
  ...
  if(isset($_POST['submit1'])) {
    ...
    $add = "UPDATE rekap_tawaran SET alur = '$_POST[status]' WHERE id='$get'";
    ...
    <div class="row no-gutters">
        <div class="col-md-2 pr-2 pt-4" id="side">
            ...
            <form action="edit.php?edit=<?php echo $id1 ?>" method="post" enctype="multipart/form-data">
                <center>
                    <h3> <i class="fas fa-columns"></i> Update Status </a> </h3>
                </center>
                <br>
                    ...
                    <tbody>
                        ...
                        $get = $_GET['id'];
                            ...
                            while ($row = mysqli_fetch_array($result)){ 
                                ...
                                $tanggal_terima = $row['tanggal_terima_dispo'];
                ...
                <div class="progressbar">
                    <?php 
                        ...
                        $fetch_status = "SELECT * FROM tracker Where dispo_id='$get' && status LIKE '%Penawaran Vendor%'";
                        $result1 = mysqli_query($conn, $fetch_status);
                        while ($row1 = mysqli_fetch_array($result1)){
                            $tanggal_status = $row1['tanggal'];
                                
                        $fetch_status1 = "SELECT * FROM tracker Where dispo_id='$get' && status LIKE '%PO / Pre Order%'";
                        $result2 = mysqli_query($conn, $fetch_status1);
                        while ($row2 = mysqli_fetch_array($result2)){
                            $tanggal_status1 = $row2['tanggal'];
        

                        $bbb = "SELECT * FROM tracker Where dispo_id='$get' && status LIKE '%Barang Datang%'";
                        $ccc = mysqli_query($conn, $bbb);
                        while ($ddd = mysqli_fetch_array($ccc)){
                            $tanggal_status3 = $ddd['tanggal'];

                        $fetch_status2 = "SELECT * FROM tracker Where dispo_id='$get' && status LIKE '%Pembayaran%'";
                        $result3 = mysqli_query($conn, $fetch_status2);
                        while ($row3 = mysqli_fetch_array($result3)){
                            $tanggal_status2 = $row3['tanggal'];
                    ...
                    <div class="progress" id="progress"></div>
                        <div class="progress-step" data-title="Disposisi">
                            <br>
                            <br>
                            <br>
                            <br>
                            <br>
                            <div style="margin-top:120px; font-size:17pt"> <?php echo $tanggal_mulai ?> </div>    
                    </div>
                    <div class="progress" id="progress"></div>
                        <div class="progress-step" data-title="Disposisi Masuk">  
                            <br>
                            <br>
                            <br>
                            <br>
                            <br>
                            <div style="margin-top:120px; font-size:17pt"> <?php echo $tanggal_terima ?> </div>     
                    </div>
                    <div class="progress" id="progress"></div>
                        <div class="progress-step" data-title="Penawaran Vendor">  
                            <br>
                            <br>
                            <br>
                            <br>
                            <br>
                            <div style="margin-top:120px; font-size:17pt"> <?php echo $tanggal_status ?> </div> 
                    </div>
                    <div class="progress" id="progress"></div>
                        <div class="progress-step" data-title="PO / Pre Order">     
                            <br>
                            <br>
                            <br>
                            <br>
                            <br>
                            <div style="margin-top:120px; font-size:17pt"> <?php echo $tanggal_status1 ?> </div> 
                    </div>
                    <div class="progress" id="progress"></div>
                        <div class="progress-step" data-title="Barang Datang">  
                            <br>
                            <br>
                            <br>
                            <br>
                            <br>
                            <div style="margin-top:120px; font-size:17pt"> <?php echo $tanggal_status3 ?> </div>    
                    </div>
                    <div class="progress" id="progress"></div>
                        <div class="progress-step" data-title="Pembayaran">  
                            <br>
                            <br>
                            <br>
                            <br>
                            <br>
                            <div style="margin-top:120px; font-size:17pt"> <?php echo $tanggal_status2 ?> </div>    
                    </div>
                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="form-group" style="width: 100%;">
                                            ...
                                            <select style="width: 100%; background-color: white; border: 2px solid #4C724A; border-radius:20px" name="alur" class="country form-control">
                                                ...
                                                <?php 
                                                    $sasaran_kerjasama = mysqli_query($conn, "SELECT * FROM alur");
                                                    while ($sasaran_kerjasama_1 = mysqli_fetch_array($sasaran_kerjasama))
                                                    {
                                                ?>
                                                <option value="<?php echo $sasaran_kerjasama_1['alur_pengadaan']; ?>">
                                                    <?php echo $sasaran_kerjasama_1['alur_pengadaan'] ?>
                                                </option>
                                                <?php
                                                    }
                                                ?>
                                        ...
                                        <div class="form-group" style="width:100%; color: black;">
                                            <label for="Name" style="font-weight: bold; color: black"> Tanggal </label>
                                            <input style="height:38px; width:100%; background-color: white; border: 1px solid #4C724A; border-radius:20px" class="box" type="datetime-local" name="tanggal_proses" placeholder="...Select Date...">
                                        </div>
                                        <div class="" style="color:black;">
                                            Status pengadaan saat ini : <?php echo $alur ?>
                                        </div>           
                                    </div>
                                </div>
                            </div>
                ...
                <div class="button" style="width:100%">
                    <div class="form-group1">
                        <center>
                            <div class="action">
                                <input style="background-color: #183F8C; border: none; font-size: 20pt; padding: 10px 100px; border-radius: 20px; color:white; margin-top:80px; margin-bottom:30px;" type="submit" class="btn btn-next" name="submit1" value="Update"> 
                            </div>
                        </center>
                    </div>
                </div>
