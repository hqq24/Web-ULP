...
<?php
  ...
  if(isset($_POST['submit1'])) {
    ...
    $add = "UPDATE rekap_tawaran SET kuitansi = '$_POST[status]' WHERE id='$get'";
    ...
    <div class="row no-gutters">
        <div class="col-md-2 pr-2 pt-4" id="side">
            ...
            <form action="edit.php?edit=<?php echo $id1 ?>" method="post" enctype="multipart/form-data">
                <center>
                    <h3> <i class="fas fa-columns"></i> Update Status Faktur Pajak </a> </h3>
                </center>
                <br>
                <table class="table table-hover table-responsive" style="border-radius: 20px;  width:100%">
                    <thead>
                        ...
                        <th scope="col" style="width:300px; background-color:#183F8C; opacity:0.8; color:white">Faktur Pajak</th>                        
                        </tr>
                    </thead>
                    <tbody>
                        <?php 
                ...
                <div class="button" style="width:100%">
                    <div class="form-group1">
                        <center>
                            <div class="action">
                                <input style="background-color: #183F8C; border: none; font-size: 20pt; padding: 10px 100px; border-radius: 20px; color:white; margin-top:80px; margin-bottom:30px;" type="submit" class="btn btn-next" name="submit_pajak" value="Update"> 
                            </div>
                        </center>
                    </div>
                </div>
